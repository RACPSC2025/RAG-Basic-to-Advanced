"""
Configuración centralizada - RAG Legal Fénix.
...
class Settings:
    ...
    AWS_MODEL_SIMPLE_TEXT: str = os.getenv("AWS_MODEL_SIMPLE_TEXT", "arn:aws:bedrock:us-east-2:762233737662:inference-profile/us.amazon.nova-lite-v1:0")
    TEMPERATURE: float =  os.getenv("LLM_TEMPERATURE", "0.0")          # Cero para dominio legal — NUNCA improvisar
    MAX_TOKENS: int = int(os.getenv("LLM_MAX_TOKENS", "2048"))

    # ── Embeddings ──────────────────────────────────────────────────────────
    AWS_MODEL_DEEP_ANALYSIS: str = os.getenv("AWS_MODEL_DEEP_ANALYSIS", "arn:aws:bedrock:us-east-2:762233737662:inference-profile/us.meta.llama3-3-70b-instruct-v1:0")
    ...
    DATA_INPUT_PATH: str = str(_ROOT / "data" / "input")
